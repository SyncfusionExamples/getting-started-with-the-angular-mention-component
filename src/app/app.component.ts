...
export class AppComponent {
  ...
  public projects: object[] = [
    { Id: 'Project1', Name: 'ERP' }, 
    { Id: 'Project2', Name: 'Help desk' },
    { Id: 'Project3', Name: 'Banking' }, 
    { Id: 'Project4', Name: 'Chat Box' },
    { Id: 'Project5', Name: 'Accounts' }
  ]

  public commentField: object = {text:"Name"}
}
